...
class DRAGAN():
    def __init__(self, FLAGS):
        ...
        # random sampled tags
        # self.r_tags = tf.placeholder(tf.float32, shape=[None, 2])
    ...
    def build(self):
        ...
        # wrong_imgs => sampled by pc based on wrong tags
        ...
        # wrong logits and labels => results of pc's analysis given imgs generated by the generator using wrong tags
        ...
        # l_wrong => used for evaluate discriminator's logit loss on wrong logits
        # closed to zero is better
        ...
        # c_wrong => used for evaluate discriminaor's label loss on wrong labels based on wrong tags
        ...
        self.g_loss = self.lambda_adv*self.g_fake + self.c_fake
        self.d_loss = self.lambda_adv*self.l_real + self.c_real + self.lambda_adv*self.l_fake + self.c_fake + self.lambda_gp*self.gradient_penalty
